...
#define	OPTION(option)		openDHANA_option_store[#option].getValue ()
#define	OPTION_DEFAULT(option)	openDHANA_option_store[#option].getDefaultValue ()
...
#define STARTING(module)        openDHANA__generic__log_info ("main/exec", "starting \"" + string(module) + "\".", __func__, __LINE__)
#define STOPPING(module)        openDHANA__generic__log_info ("main/exec", "stopping \"" + string(module) + "\".", __func__, __LINE__)


#define	CONFIG_DIR		"/etc/openDHANA"
#define	CONFIG_DIR_OZW		CONFIG_DIR  "/ozw"
#define	CONFIG_DIR_VISUAL	CONFIG_DIR  "/visual"
#define	CONFIG_DIR_SCRIPTOR	CONFIG_DIR  "/scriptor"
#define	CONFIG_DIR_IR		CONFIG_DIR  "/ir"
#define	CONFIG_DIR_SERIAL	CONFIG_DIR  "/serial"
#define	CONFIG_DIR_LOGGER	CONFIG_DIR  "/logger"

#define OPTIONS_FILE_OZW	CONFIG_DIR_OZW  	"/openDHANA_ozw.options"
#define OPTIONS_FILE_VISUAL	CONFIG_DIR_VISUAL  	"/openDHANA_visual.options"
#define OPTIONS_FILE_SCRIPTOR	CONFIG_DIR_SCRIPTOR  	"/openDHANA_scriptor.options"
#define OPTIONS_FILE_IR		CONFIG_DIR_IR	  	"/openDHANA_ir.options"
